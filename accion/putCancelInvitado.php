...
if ($agenda != null) {
       ...
       $arr = array();
       if ($agenda->getIdUsuario() != 0) {
              array_push($arr, $agenda->getIdUsuario());
       }
       ...
       sendPushToUsers($arr, "🎾 GO Padel", $_SESSION['userNombre'] . " se ha retirado de un partido. Revisa en tus reservas y buen juego.", '/landing.php');
}
