class VersionControl {
  ...
  showUpdateModal(versionInfo, isForced = false) {
    ...
    const modalConfig = {
      title: isForced ? '¡Actualización Requerida!' : 'Nueva Versión Disponible',
      html: `
  ...
  async performVersionCheck() {
    ...
    const isOutdated = this.compareVersions(this.currentVersion, minVersion) < 0;
    
    // Verificar si hay una nueva versión disponible
    const hasUpdate = this.compareVersions(this.currentVersion, serverVersion) < 0;
