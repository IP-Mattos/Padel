<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'GET'){   
        ...
        foreach(getallheaders()as $clave=>$valor){
            if($clave === "fechaDesde"){$fechaDesde = $valor;}
            if($clave === "fechaHasta"){$fechaHasta = $valor;}
        ...
        $horas = Agenda::recuperarTodosIdUserFech($fechaDesde, $fechaHasta, $idUser);
        ...
        if($horas){
                ...
                $return['detalleError'] = "No se encontraron horas de este usuario";
                $return['fechaHora'] = $fechHora;
                $respose['consultaResponse'] = $return;
                echo json_encode( $respose );
                exit();
