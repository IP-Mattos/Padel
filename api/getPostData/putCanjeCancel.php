<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'PUT'){
        ...
        if($idUser>0 && $idCanje>0){
            Canje::borrarRegistro($idCanje);
            $canje = Canje::buscarPorId($idCanje);
            if($canje){
                   
                        header("HTTP/1.1 400 Bad Request");
                        $return['codigoError'] = "3";
                        $return['detalleError'] = "No se pudo eliminar el canje.";
                        $return['fechaHora'] = $fechHora;
                 ...
                 //si no hay registro
                        ...
                        $return['detalleError'] = "Canje eliminado correctamente.";
            ...
            $return['codigoError'] = "10";
            $return['detalleError'] = "Faltan datos para eliminar el canje.";
            $return['fechaHora'] = $fechHora;
            $respose['consultaResponse'] = $return;
            echo json_encode( $respose );
            exit();
