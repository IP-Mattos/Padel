<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'PUT'){   
        ...
        if($arrHoras){
            ...
            $agenda = new Agenda(null,$fecha,$arrHoras,$usuario,3,date("Y-m-d H:i:s"),$servicio,0,0,"",0,0,0);
            $agenda->guardar();
            
                //si no hay registro
                header("HTTP/1.1 200 OK");
                $return['codigoError'] = "0";
                $return['detalleError'] = "Hora Restringida Correctamente";
            ...
            $return['detalleError'] = "No llego hora para restringir";
            $return['fechaHora'] = $fechHora;
            $respose['consultaResponse'] = $return;
            echo json_encode( $respose );
            exit();
