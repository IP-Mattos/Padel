...
if ($_SERVER['REQUEST_METHOD'] == 'PUT') {
    ...
    if ($arrHoras) {
        ...
        $Uss = Usuarios::buscarPorId($usuario);
        ...
        $whatsSend = setLoginUserFast($mensaje, $Uss->getCelular(), $Uss->getNombre() . " - " . $Uss->getCelular() . " Reserva horas para el día " . $fecha .
            " en el horario " . $arrHoras . " en la cancha " . $servicio->getNombre());
