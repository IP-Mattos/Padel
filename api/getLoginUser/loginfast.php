    ...
    $mensajeSMS = "";
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'GET'){  
                ...
                try{
                    ...
                    $UsCl = base64_decode($UsCl);
                    //echo $UsCl. "<br>";
                    $UsCd = base64_decode($UsCd);
                    //echo $UsCd. "<br>";
                ...
                if (isset($UsCl) && isset($UsCd)){
                      ...
                      //  print_r("    ");
                       // print_r($UsCd);
                        $sql->bindValue(':UsCl', $UsCl);
                        $sql->bindValue(':UsCd', $UsCd);
                        $sql->execute();
                        ...
                        $arryTok=getTocken($data);
                            ...
                            try {
                                ...
                                if( $usSMS == true ){
                                    //MANDO WHATSAPP
                                    $mensaje = "login";
                                    $whatsSend = setLoginUserFast($mensaje,$UsCl,$data["nombre"]);
                                    $ret['whatsSend'] = $whatsSend;
                                    $sneds = setActualizarEnvioClave();
                                    $mensajeSMS =  "Te llegara un WhatsApp con un codigo para ingresar.";
                                }
