...
class Usuarios
{
    ...
    public function getBeneficiarioDe()
    {
        return $this->beneficiarioDe;
    }
    ...
    public function getMascategoria()
    {
        return $this->mascategoria;
    }
    ...
    public function getMisestrellas()
    {
        return $this->misestrellas;
    } // Nuevo getter
    ...
    public function setBeneficiarioDe($beneficiarioDe)
    {
    ...
    public function setMascategoria($mascategoria)
    {
    ...
    public function setMisestrellas($misestrellas)
    {
        $this->misestrellas = $misestrellas;
    } // Nuevo setter
